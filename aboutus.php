    ...
    <div class="sub-container">
      <div class="row text-center">
        <div class="col-sm-12 col-md-4">
          <div class="teams">
          <img class="img-thumbnail"src="" alt="" height="100px">
            <div class="names mt-3"><h5 class="fs-4 fw-bold">Name</h5></div>
            <div class="design"><small class="fw-bold fst-italic">Position</small></div>
            <div class="about py-3 p-3"><p class="lh-lg">Contributor</p></div>
  ...
  <footer class="mt-5">
    <div class="text-center">
      ...
      <p class="text-white fw-light">
        ...
        <span class="d-block">Ridho Alba</span>
